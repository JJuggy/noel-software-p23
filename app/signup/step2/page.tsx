    ...
    <div className="relative w-screen h-screen overflow-hidden bg-white">
                ...
                <div key={step.num} className="relative" style={{ width: "31px", height: "31px" }}>
                  ...
                  <span
                    ...
                    style={{
                      fontFamily: "'Montserrat', sans-serif",
                      fontWeight: 600,
                      color: step.done || step.active ? "#0B1727" : "#F3F0E9",
                    }}
                  >
                    {step.num}
                  </span>
      ...
      >
        ...
        <form onSubmit={handleProceed} className="flex flex-col gap-[23px]">
          ...
          <FloatingInput
            label="Select interested industry"
            value={industry}
            ...
            rightIcon={
              <img
                src={imgDropdown}
                alt=""
                style={{ width: "18px", height: "18px", transform: "scaleY(-1)" }}
              />
            }
          />
            ...
            <div className="flex flex-wrap gap-x-[16px] gap-y-[8px]">
              {CHIPS.map((chip) => {
                ...
                return (
                  ...
                  >
                    <img
                      src={isActive ? imgChipActive : imgChipDefault}
                      alt=""
